...
* `frontend/` exists on Next.js + React + TypeScript + Tailwind + React Context (with react-pdf and react-resizable-panels), not the originally planned Vite/Zustand/shadcn stack. On 2026-09-16 the built stack was decided as authoritative and `docs/TECH_STACK.md` updated to describe it (`DECISIONS_LOG.md` Part 25).
